...
void _sio_init( void ) {
    ...
    */
    ...
    __memset( (void *) _inbuffer, sizeof(_inbuffer), 0 );
    _inlast = _innext = _inbuffer;
    _incount = 0;

    __memset( (void *) _outbuffer, sizeof(_outbuffer), 0 );
    _outlast = _outnext = _outbuffer;
    _outcount = 0;
    _sending = 0;
